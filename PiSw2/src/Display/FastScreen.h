...
class FastScreen : public CDevice	/// Writing characters to screen
{
public:
	...
	FastScreen (unsigned nWidth, unsigned nHeight, boolean bVirtual = FALSE);
	...
	FastScreenStatus GetStatus (void);
	...
	boolean SetStatus (const FastScreenStatus &Status);
#endif
