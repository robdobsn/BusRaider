...
// Constructor
CPUHandler::CPUHandler(BusRawAccess& busRawAccess, 
        MemoryInterface& memoryInterface,
        CPUProgrammerIF& cpuProgrammer)
    : _busRawAccess(busRawAccess), 
      _memoryInterface(memoryInterface),
      _cpuProgrammer(cpuProgrammer)
{
    cycleClear();
    _isSuspended = false;
    _pBusAccessCB = NULL;
...
// Service
void CPUHandler::service(bool dontStartAnyNewBusActions)
{
...
// Suspend
void CPUHandler::suspend(bool suspend)
{
...
bool CPUHandler::debuggerBreak()
{
    ...
    // Set to wait on MREQ
    _busRawAccess.waitConfigDebugger(true, false);
...
// Debugger continue
void CPUHandler::debuggerContinue()
{
    // Go into free-running mode
    _debuggerState = DEBUGGER_STATE_FREE_RUNNING;

    // Set to wait on MREQ
    _busRawAccess.waitConfigDebugger(false, false);
...
// Debugger step-in
bool CPUHandler::debuggerStepIn()
{
...
// Target RESET
void CPUHandler::targetReset()
{
    debuggerContinue();
    _busRawAccess.resetTargetCPU(_cpuSettings.resetDurationMs);
}

// Target INT (interrupt)
void CPUHandler::targetINT()
{
    // TODO 2020
}

// Target NMI (non-maskable interrupt)
void CPUHandler::targetNMI()
{
    // TODO 2020
}
...
void CPUHandler::getRegsFormatted(char* pBuf, int len)
{
    _z80Registers.format(pBuf, len);
}

void CPUHandler::getRegsJSON(char* pBuf, int len)
{
...
// // Module name
// static const char MODULE_PREFIX[] = "CPUHandler";

// // Constructor
// CPUHandler::CPUHandler(BusControl& busControl)
...
//     //         true,
//     //         CPUHandler::handleWaitInterruptStatic,
//     //         CPUHandler::busReqAckedStatic,
//     //         false,
//     //         false,
//     //         // Reset
//     //         false,
...
// // Service
// void CPUHandler::service()
// {

// }

// //Enable
// void CPUHandler::enable(bool en, bool waitHold)
// {
//     // TODO 2020
//     // _stepMode = STEP_MODE_STEP_PAUSED;
//     // if (en)
...
// bool CPUHandler::isTrackingActive()
// {
//     // TODO 2020
...
// void CPUHandler::startSetRegisterSequence(Z80Registers* pRegs)
// {
//     // TODO 2020
//     // // Set regs
//     // if (pRegs)
...
// void CPUHandler::store16BitVal(uint8_t arry[], int offset, uint16_t val)
// {
//     arry[offset] = val & 0xff;
//     arry[offset+1] = (val >> 8) & 0xff;
// }

// int CPUHandler::getInstructionsToSetRegs(Z80Registers& regs, uint8_t* pCodeBuffer, uint32_t codeMaxlen)
// {
...
// CPUHandler::OPCODE_INJECT_PROGRESS CPUHandler::handleRegisterGet(uint32_t addr, uint32_t data, uint32_t flags, uint32_t& retVal)
// {
...
// CPUHandler::OPCODE_INJECT_PROGRESS CPUHandler::handleRegisterSet(uint32_t& retVal)
// {
//     // Fill in the register values
//     if (_snippetPos == 0)
//     {
...
// void CPUHandler::stepTo(uint32_t toAddr)
// {
//     // TODO 2020
...
// // void CPUHandler::stepPause(bool allowInjection)
// // {
...
// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// bool CPUHandler::isPrefixInstruction(uint32_t instr)
// {
//     switch(instr)
//     {
//         case 0xdd:
...
// bool CPUHandler::trackPrefixedInstructions(uint32_t flags, uint32_t data, uint32_t retVal)
// {
//     // Value read/written
...
// bool CPUHandler::handlePendingDisable()
// {
//     // TODO 2020
//     // if (_disablePending)
//     // {
...
// void CPUHandler::busReqAckedStatic(void* pObject, BR_BUS_ACTION actionType,  BR_BUS_REQ_REASON reason)
// {
//     if(!pObject)
//         return;
//     ((CPUHandler*)pObject)->busReqAcked(actionType, reason);
// }

// void CPUHandler::busReqAcked(BR_BUS_ACTION actionType,  BR_BUS_REQ_REASON reason)
// {
...
// void CPUHandler::handleWaitInterruptStatic(void* pObject, uint32_t addr, uint32_t data, 
//         uint32_t flags, uint32_t& retVal)
// {
//     if (!pObject)
//         return;
//     ((CPUHandler*)pObject)->handleWaitInterrupt(addr, data, flags, retVal);
// }

// void CPUHandler::handleWaitInterrupt(uint32_t addr, uint32_t data, 
//         uint32_t flags, uint32_t& retVal)
// {
//     // Only handle MREQs
...
// void CPUHandler::handleStepOverBkpts( uint32_t addr,  uint32_t data, 
//         uint32_t flags,  uint32_t& retVal)
// {
//     // Ignore if injecting
//     if ((_targetStateAcqMode == TARGET_STATE_ACQ_INJECTING) || 
...
// void CPUHandler::handleTrackerIdle( uint32_t addr, uint32_t data, 
//         uint32_t flags, uint32_t& retVal)
// {
//     // Check for disable
//     if (handlePendingDisable())
...
// void CPUHandler::handleInjection(uint32_t addr, uint32_t data, 
//         uint32_t flags, uint32_t& retVal)
// {
//     // TODO 2020
...
// //             // ensure BUSRQ is handled synchronously with the CPUHandler operation when MREQ waits are
