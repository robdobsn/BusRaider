...
FastScreen::FastScreen (unsigned nWidth, unsigned nHeight, boolean bVirtual)
:	m_nInitWidth (nWidth),
...
boolean FastScreen::Initialize (void)
{
	if (!m_bVirtual)
	{
...
unsigned FastScreen::GetWidth (void) const
{
	return m_nWidth;
}

unsigned FastScreen::GetHeight (void) const
{
	return m_nHeight;
}

unsigned FastScreen::GetColumns (void) const
{
	return m_nWidth / m_CharGen.GetCharWidth ();
}

unsigned FastScreen::GetRows (void) const
{
	return m_nUsedHeight / m_CharGen.GetCharHeight ();
}

CBcmFrameBuffer *FastScreen::GetFrameBuffer (void)
{
	return m_pFrameBuffer;
}

FastScreenStatus FastScreen::GetStatus (void)
{
	FastScreenStatus Status;
...
boolean FastScreen::SetStatus (const FastScreenStatus &Status)
{
...
int FastScreen::Write (const void *pBuffer, size_t nCount)
{
	m_SpinLock.Acquire ();
...
void FastScreen::Write (char chChar)
{
	switch (m_nState)
	{
...
void FastScreen::CarriageReturn (void)
{
	m_nCursorX = 0;
}

void FastScreen::ClearDisplayEnd (void)
{
	ClearLineEnd ();
...
void FastScreen::ClearLineEnd (void)
{
...
void FastScreen::CursorDown (void)
{
...
void FastScreen::CursorHome (void)
{
	m_nCursorX = 0;
	m_nCursorY = m_nScrollStart;
}

void FastScreen::CursorLeft (void)
{
	if (m_nCursorX > 0)
	{
...
void FastScreen::CursorMove (unsigned nRow, unsigned nColumn)
{
...
void FastScreen::CursorRight (void)
{
	m_nCursorX += m_CharGen.GetCharWidth ();
...
void FastScreen::DeleteChars (unsigned nCount)	// TODO
{
}

void FastScreen::DeleteLines (unsigned nCount)	// TODO
{
}

void FastScreen::DisplayChar (char chChar)
{
	// TODO: Insert mode
...
void FastScreen::EraseChars (unsigned nCount)
{
	if (nCount == 0)
	{
		return;
...
void FastScreen::InsertLines (unsigned nCount)	// TODO
{
}

void FastScreen::InsertMode (boolean bBegin)
{
	m_bInsertOn = bBegin;
}

void FastScreen::NewLine (void)
{
	CarriageReturn ();
	CursorDown ();
}

void FastScreen::ReverseScroll (void)
{
	if (   m_nCursorX == 0
	    && m_nCursorY == 0
	)
...
void FastScreen::SetCursorMode (boolean bVisible)
{
	m_bCursorOn = bVisible;
}

void FastScreen::SetScrollRegion (unsigned nStartRow, unsigned nEndRow)
{
...
void FastScreen::SetStandoutMode (unsigned nMode)
{
	switch (nMode)
	{
	case 0:
...
void FastScreen::Tabulator (void)
{
...
void FastScreen::DisplayChar (char chChar, unsigned nPosX, unsigned nPosY, TScreenColor Color)
{
...
void FastScreen::EraseChar (unsigned nPosX, unsigned nPosY)
{
	for (unsigned y = 0; y < m_CharGen.GetCharHeight (); y++)
	{
		for (unsigned x = 0; x < m_CharGen.GetCharWidth (); x++)
...
void FastScreen::InvertCursor (void)
{
	if (!m_bCursorOn)
	{
		return;
...
void FastScreen::SetPixel (unsigned nPosX, unsigned nPosY, TScreenColor Color)
{
	if (   nPosX < m_nWidth
	    && nPosY < m_nHeight)
	{
...
TScreenColor FastScreen::GetPixel (unsigned nPosX, unsigned nPosY)
{
	if (   nPosX < m_nWidth
	    && nPosY < m_nHeight)
	{
...
void FastScreen::Rotor (unsigned nIndex, unsigned nCount)
{
