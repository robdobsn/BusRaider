...
void TargetImager::setCPURegistersStatic(const Z80Registers& regs, void* pProgrammer)
{
    if (pProgrammer)
        ((TargetImager*)pProgrammer)->setCPURegisters(regs);
}

void TargetImager::setCPURegisters(const Z80Registers& regs)
{
    _cpuRegisters = regs;
