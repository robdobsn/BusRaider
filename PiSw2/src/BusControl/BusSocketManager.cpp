...
BusSocketManager::BusSocketManager(CPUHandler& cpuHandler)
...
{
    _cpuHandler.registerCallbacks(busAccessCallbackStatic, busReqAckedStatic, this);
}
...
{
    // _cpuHandler.bus().waitSuspend(suspend);
...
int BusSocketManager::socketAdd(bool enabled, CPUCycleCBType* busAccessCallback,
