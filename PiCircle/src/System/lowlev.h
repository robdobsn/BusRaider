...
extern void lowlevBlockCopyExecRelocatable(void* pDest, void* pSrc, int len, void* execAddr);
typedef void lowlevBlockCopyExecRelocatableFnT(uint8_t* pDest, uint8_t* pSrc, int len, void* execAddr);
