...
class CRdSerialDevice : public CDevice		/// Driver for PL011 UART0 at GPIO14/15
{
public:
	...
	CRdSerialDevice (CInterruptSystem *pInterruptSystem = 0, boolean bUseFIQ = FALSE);

	~CRdSerialDevice (void);
#endif
