...
extern FB_RETURN_TYPE fb_get_physical_buffer_size(unsigned int* pWidth, unsigned int* pHeight);
extern FB_RETURN_TYPE fb_set_physical_buffer_size(unsigned int* pWidth, unsigned int* pHeight);
