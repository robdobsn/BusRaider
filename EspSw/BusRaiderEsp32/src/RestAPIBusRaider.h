...
class RestAPIBusRaider
{
  ...
  public:
    ...
    void apiFileUpload(String filename, size_t index, uint8_t *data, size_t len, bool final)
    {
    ...
    void setup(RestAPIEndpoints &endpoints)
    {
        ...
        endpoints.addEndpoint("upload", 
                            ...
                            std::bind(&RestAPIBusRaider::apiFileStart, this, std::placeholders::_1, std::placeholders::_2),
