...
CRdSerialDevice::CRdSerialDevice (CInterruptSystem *pInterruptSystem, boolean bUseFIQ)
:
...
CRdSerialDevice::~CRdSerialDevice (void)
{
	PeripheralEntry ();
...
boolean CRdSerialDevice::Initialize (unsigned nBaudrate)
{
...
int CRdSerialDevice::Write (const void *pBuffer, size_t nCount)
{
...
int CRdSerialDevice::Read (void *pBuffer, size_t nCount)
{
	u8 *pChar = (u8 *) pBuffer;
	assert (pChar != 0);
...
unsigned CRdSerialDevice::GetOptions (void) const
{
	return m_nOptions;
}

void CRdSerialDevice::SetOptions (unsigned nOptions)
{
	m_nOptions = nOptions;
}

void CRdSerialDevice::RegisterMagicReceivedHandler (const char *pMagic, TMagicReceivedHandler *pHandler)
{
	assert (m_pInterruptSystem != 0);
	assert (m_pMagic == 0);
...
unsigned CRdSerialDevice::AvailableForWrite (void)
{
	assert (m_pInterruptSystem != 0);
...
unsigned CRdSerialDevice::AvailableForRead (void)
{
	assert (m_pInterruptSystem != 0);
...
void CRdSerialDevice::Flush (void)
{
	PeripheralEntry ();
...
boolean CRdSerialDevice::Write (u8 uchChar)
{
	boolean bOK = TRUE;
...
void CRdSerialDevice::InterruptHandler (void)
{
...
void CRdSerialDevice::InterruptStub (void *pParam)
{
	CRdSerialDevice *pThis = (CRdSerialDevice *) pParam;
	assert (pThis != 0);
...
int CRdSerialDevice::Write (const void *pBuffer, unsigned nCount)
{
	asm volatile
	(
		"push {r0-r2}\n"
